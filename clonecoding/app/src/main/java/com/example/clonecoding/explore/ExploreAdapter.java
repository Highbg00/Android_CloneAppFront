...
public class ExploreAdapter extends RecyclerView.Adapter<ExploreAdapter.ViewHolder> {
    ...
    public ExploreAdapter(LayoutInflater inflater, ArrayList<ExploreDTO> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ExploreAdapter.ViewHolder(inflater.inflate(R.layout.item_explore, parent,false));
    }
